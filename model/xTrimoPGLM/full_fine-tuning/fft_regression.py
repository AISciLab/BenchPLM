...
def train_and_evaluate(run_id, model_name='model', learning_rate=2e-5, num_epochs=100, batch_size=4):
    ...
    model = XTrimoPGLMForSequenceRegression(base_model)
    ...
    print(f"xTrimoPGLM Regression Run {run_id} Results (Original Scale):")
