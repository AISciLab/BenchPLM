...
def run_benchmark(dataset_name: str, train_data: pd.DataFrame, test_data: pd.DataFrame, args):
    ...
    print(f"\n===== Running ESM3 FFT Benchmark for: {dataset_name} =====")
    ...
    training_args = TrainingArguments(
        output_dir=f'./output/FFT_ESM3/{dataset_name}/Run_results_{args.run_time}',
        ...
        save_total_limit=1,
        logging_dir=f"./logs/FFT_ESM3/{dataset_name}/run_{args.run_time}",
        logging_steps=100,
        bf16=True,
    ...
    print("--- Starting ESM3 Full Fine-Tuning ---")
    trainer.train()
    print("--- Training Finished ---")

    # Save the best model
    checkpoint_dir = f"./checkpoint/FFT_ESM3/{dataset_name}/ESM3_{args.run_time}"
    ...
    print(f"===== ESM3 FFT Benchmark for {dataset_name} Finished =====\n")


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="ESM3 Full Fine-Tuning Benchmark")
    ...
    if args.dataset in DATASET_CONFIG:
        ...
        # Load data using the configured loader and paths
